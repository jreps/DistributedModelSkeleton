...
createCohorts <- function(
  ...
  cohortDefinitionSet <- CohortGenerator::getCohortDefinitionSet(packageName = "SkeletonDistributedModel",
...
addCohortNames <- function(data, IdColumnName = "cohortId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("Cohorts.csv", package = "SkeletonDistributedModel")
